# Generated by Django 3.2.15 on 2023-05-19 18:52
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('access_level', models.CharField(choices=[('admin', 'Администратор'), ('user', 'Авторизованный пользователь')], default='user', max_length=150, verbose_name='Уровень доступа')),
